...
I use the following command for the Gnome keybind: sh -c "/home/aetea/.scripts/screenshot.sh aup"
...
For uploading functionality you need to set the following environment variables (you can set them in settings.sh):
  ...
  UPLOAD_PASS: The SSH user's password.
...
Command Usage (Same as running the command with "help" (without quotes) as the only parameter):
